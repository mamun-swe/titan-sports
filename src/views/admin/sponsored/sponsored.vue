        ...
        >
          <div class="card">
            ...
            <div class="custom-overlay p-2 text-right">
              <i class="far fa-trash-alt delete" v-on:click="deleteOrganization(organization)"></i>
            </div>
          </div>
        </div>

        <div class="col-12 col-sm-6 col-md-4 col-lg-3 mb-3 px-sm-2 add-column">
          <div class="card" v-on:click="openAddNewOrganizationDataModal">
            <div class="flex-center flex-column">
    ...
    <div class="custom-modal" ref="addmodal">
      <div class="flex-center">
        <div class="card">
          ...
          <div class="card-body">
            <h5 class="text-muted mb-3">Add new organization</h5>
            <form @submit.prevent="doPost">
              <div class="form-group mb-3">
                <small class="text-danger" v-if="errors.link_err">{{errors.link_err}}</small>
                <input
                  type="text"
                  class="form-control shadow-none"
                  placeholder="Website link"
                  v-model="organizationData.link"
                />
              </div>
...
export default {
  ...
  methods: {
    ...
    // Add new banner
    handleFileUpload() {
      this.organizationData.file = this.$refs.file.files[0];
    },
    openAddNewOrganizationDataModal() {
    ...
    doPost() {
      ...
      } else if (!this.organizationData.file) {
